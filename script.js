...
function checkBoard() {
  for (let i = 0; i < winningArrayes.length; i++) {
    const square1 = squares[winningArrayes[i][0]];
    const square2 = squares[winningArrayes[i][1]];
    const square3 = squares[winningArrayes[i][2]];
    const square4 = squares[winningArrayes[i][3]];
